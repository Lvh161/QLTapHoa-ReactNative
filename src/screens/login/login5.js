    ...
    return(
        ...
        resizeMode='stretch' >
            ...
            <SafeAreaView style={{flex:1,width:'100%',height:'100%',justifyContent:'center', alignItems:'center'}}>
                ...
                <View style={{borderRadius:25, borderWidth:5, borderColor:'green', opacity:0.7,  width:'70%',height:'60%',backgroundColor:'white',justifyContent:'flex-start', alignItems:'center'}}>
                    {/* Phan tren logo */}
                    <View style={{borderWidth:0, flexDirection:'row', height: pxWindow.height*0.10, width:'100%',justifyContent:'center', alignItems:'center'}}>
                    ...
                    <View style={{borderWidth:0,width:'100%', flex:1,  justifyContent: 'flex-start', alignItems: 'center'}}>
                        {/* dien thong tin */}
                        <View style={{borderWidth:0, height: '80%', width:'80%',justifyContent:'center', alignItems:'center'}}>
                            <View style={{borderWidth:0,flexDirection:'row',width:'80%', height:33, justifyContent: 'space-between', alignItems:'center'}}>
                                <Text style={{color:'blue', fontSize:12, fontWeight:'800'}}>Email:</Text>
                                <TextInput 
                                            style={{borderRadius:25, fontSize:12, width:'80%', height:'100%', borderBottomColor: 'red',borderWidth:1, borderBottomWidth:2, textAlign: 'right'}}
                                            // autoCapitalize='none'
                                        />

                            </View>
                            <View style={{width:'10%', height:pxWindow.height*0.01}}></View>
                            <View style={{flexDirection:'row',width:'80%', height:33, justifyContent: 'space-between', alignItems:'center', }}>
                                <Text style={{color:'blue', fontSize:12, fontWeight:'800'}}>{'    '}MK:</Text>
                                <TextInput 
                                        style={{borderRadius:25, fontSize:12, paddingRight:35, width:'80%', height:'100%', borderBottomColor: 'red',borderWidth:1, borderBottomWidth:2, textAlign: 'right'}}
                                        autoCapitalize='none'
                                        secureTextEntry={getPV?false:true}
                                    />
                                    <TouchableOpacity style={{width:30, height:'100%', aspectRatio:1, position:'absolute', right:1}}
                                        onPress={()=>{setPV(!getPV);console.log(getPV?'Ẩn pass':'Hiện pass')}}>
                                        {getPV?
                                        <Image style={{width:'100%', height:'100%'}} source={require('../../images/hide.png')}
                                        resizeMode='contain'/>:
                                        <Image style={{width:'100%', height:'100%'}} source={require('../../images/show.png')}
                                        resizeMode='contain'/>
                                        }
                                    </TouchableOpacity>
                            ...
                            <View style={{width:'10%', height:pxWindow.height*0.01}}></View>
                            <View style={{width:'50%', flex:1,  height:pxWindow.height*0.04, alignItems:'center'}}>
                                <TouchableOpacity  style={{borderWidth:3, borderColor:'blue',width:'100%', width:pxWindow.width*0.2,backgroundColor:'silver', borderRadius:50, justifyContent:'center', alignItems:'center'}}>
                                    <Text style={{fontSize:15, fontWeight:'800'}}>Đăng nhập</Text>
